...
export const CaseHeader: React.FC = () => {
  const { currentCase, policies, selectedPolicy, selectPolicy, selectedDfRecord, selectedCaseInstanceId } = useCase();
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-8">
            <div>
              ...
              <p className="text-sm text-white/75 mt-1">Decedent: <span className="font-medium text-white">{currentCase.decedentName}</span></p>
            </div>
